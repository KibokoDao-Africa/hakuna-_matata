...
<title>Frequently asked questions section | Docs</title>
<meta property="og:title" content="Frequently asked questions section" />
<meta name="author" content="alex" />
<meta property="og:locale" content="en" />
<meta name="description" content="Create FAQ post in _faqs folder (categories are optional): --- title: Do you provide customer support? categories: [presale] ---" />
<meta property="og:description" content="Create FAQ post in _faqs folder (categories are optional): --- title: Do you provide customer support? categories: [presale] ---" />
<link rel="canonical" href="/docs/faq/" />
<meta property="og:url" content="/docs/faq/" />
<meta property="og:site_name" content="Docs" />
<meta property="og:type" content="article" />
<meta property="article:published_time" content="2020-04-01T05:11:38-05:00" />
<script type="application/ld+json">
{"description":"Create FAQ post in _faqs folder (categories are optional): --- title: Do you provide customer support? categories: [presale] ---","image":null,"@type":"BlogPosting","url":"/docs/faq/","name":null,"publisher":null,"headline":"Frequently asked questions section","dateModified":"2020-04-01T05:11:38-05:00","datePublished":"2020-04-01T05:11:38-05:00","sameAs":null,"author":{"@type":"Person","name":"alex"},"mainEntityOfPage":{"@type":"WebPage","@id":"/docs/faq/"},"@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
        ...
        <div class="uk-grid-large" data-uk-grid>
            ...
            <div class="sidebar-fixed-width uk-visible@m">
                <div class="sidebar-docs uk-position-fixed uk-margin-top">
                    ...
                    <ul class="uk-nav uk-nav-default doc-nav">
                      ...
                      <li class="uk-active"><a href="/docs/faq/">Frequently asked questions section</a></li>
            ...
            <div class="uk-width-1-1 uk-width-expand@m">
                ...
                <article class="uk-article">
                    ...
                    <h1 class="uk-article-title">Frequently asked questions section</h1>
  ...
  <time datetime="2020-04-01T05:11:38-05:00" itemprop="datePublished">
    ...
    Apr 1, 2020
                    ...
                    <div class="article-content link-primary">
                        <p>Create FAQ post in <code class="highlighter-rouge">_faqs</code> folder (categories are optional):</p>
<div class="language-yml highlighter-rouge"><pre class="highlight"><code><span class="nn">---</span>
<span class="s">title</span><span class="pi">:</span> <span class="s">Do you provide customer support?</span>
<span class="s">categories</span><span class="pi">:</span> <span class="pi">[</span><span class="nv">presale</span><span class="pi">]</span>
<span class="nn">---</span>
</code></pre>
</div>

<p>To add the following to a page:</p>

<div class="language-yaml highlighter-rouge"><pre class="highlight"><code><span class="pi">{</span><span class="err">%</span> <span class="nv">include faqs.html multiple="true" title="Frequently asked questions" category="presale" subtitle="Find quicke answers to frequent pre-sale questions asked by customers" %</span><span class="pi">}</span>
</code></pre>
</div>

<p>Specifying category is optional, if not defined all FAQ posts will be displayed. To display multiple FAQs at the same time without one collapsing when the other one is opened, add the <code class="highlighter-rouge">multiple="true"</code> attribute.</p>

                        
                            <div class="share uk-text-center uk-margin-medium-top">
    
        <a class="uk-link-muted" href="https://twitter.com/intent/tweet?text=Frequently asked questions section&url=/docs/faq/&via=&related=" rel="nofollow" target="_blank" title="Share on Twitter" onclick="window.open(this.href, 'twitter', 'width=550,height=235');return false;"><span data-uk-icon="icon: twitter; ratio: 1.2"></span></a>
    
    
        <a class="uk-link-muted uk-margin-small-left" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%3A4000%2Fdocs%2Ffaq%2F" rel="nofollow" target="_blank" title="Share on Facebook" onclick="window.open(this.href, 'facebook-share','width=580,height=296');return false;"><span data-uk-icon="icon: facebook; ratio: 1.2"></span></a>
    ...
    <div class="uk-margin-large-top paginate-post">
        <div class="uk-child-width-expand@s uk-grid-large uk-pagi" data-uk-grid>
            <div>
                    ...
                    <h5>Video lightbox boxes section</h5>
                    <div><a class="remove-underline hvr-back" href="/docs/videos/">&larr; Previous</a></div>
            ...
            <div>
                    ...
                    <h5>Team members section</h5>
                    <div class="uk-text-right"><a class="remove-underline hvr-forward" href="/docs/team/">Next &rarr;</a></div>
