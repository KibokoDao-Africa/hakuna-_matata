...
<title>Hero page header | Docs</title>
<meta property="og:title" content="Hero page header" />
<meta name="author" content="john" />
<meta property="og:locale" content="en" />
<meta name="description" content="To add a hero header to a page add the following to a YAML Front Matter:" />
<meta property="og:description" content="To add a hero header to a page add the following to a YAML Front Matter:" />
<link rel="canonical" href="/docs/hero/" />
<meta property="og:url" content="/docs/hero/" />
<meta property="og:site_name" content="Docs" />
<meta property="og:type" content="article" />
<meta property="article:published_time" content="2020-04-01T05:11:38-05:00" />
<script type="application/ld+json">
{"description":"To add a hero header to a page add the following to a YAML Front Matter:","image":null,"@type":"BlogPosting","url":"/docs/hero/","name":null,"publisher":null,"headline":"Hero page header","dateModified":"2020-04-01T05:11:38-05:00","datePublished":"2020-04-01T05:11:38-05:00","sameAs":null,"author":{"@type":"Person","name":"john"},"mainEntityOfPage":{"@type":"WebPage","@id":"/docs/hero/"},"@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
        ...
        <div class="uk-grid-large" data-uk-grid>
            ...
            <div class="sidebar-fixed-width uk-visible@m">
                <div class="sidebar-docs uk-position-fixed uk-margin-top">
                    ...
                    <ul class="uk-nav uk-nav-default doc-nav">
                      ...
                      <li class="uk-active"><a href="/docs/hero/">Hero page header</a></li>
            ...
            <div class="uk-width-1-1 uk-width-expand@m">
                ...
                <article class="uk-article">
                    ...
                    <h1 class="uk-article-title">Hero page header</h1>
  ...
  <time datetime="2020-04-01T05:11:38-05:00" itemprop="datePublished">
    ...
    Apr 1, 2020
                    ...
                    <div class="article-content link-primary">
                        <p>To add a hero header to a page add the following to a YAML Front Matter:</p>
...
<span class="s">width</span><span class="pi">:</span> <span class="s">expand</span>
<span class="s">hero</span><span class="pi">:</span>
    <span class="s">title</span><span class="pi">:</span> <span class="s">How can we help you?</span>
    <span class="s">subtitle</span><span class="pi">:</span> <span class="s">Search or browse in depth articles and videos</span>
    <span class="s">image</span><span class="pi">:</span> <span class="s">knowledge.svg</span>
...
<span class="nn">---</span>
        ...
        <a class="uk-link-muted" href="https://twitter.com/intent/tweet?text=Hero page header&url=/docs/hero/&via=&related=" rel="nofollow" target="_blank" title="Share on Twitter" onclick="window.open(this.href, 'twitter', 'width=550,height=235');return false;"><span data-uk-icon="icon: twitter; ratio: 1.2"></span></a>
    
    
        <a class="uk-link-muted uk-margin-small-left" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%3A4000%2Fdocs%2Fhero%2F" rel="nofollow" target="_blank" title="Share on Facebook" onclick="window.open(this.href, 'facebook-share','width=580,height=296');return false;"><span data-uk-icon="icon: facebook; ratio: 1.2"></span></a>
    ...
    <div class="uk-margin-large-top paginate-post">
        <div class="uk-child-width-expand@s uk-grid-large uk-pagi" data-uk-grid>
            <div>
                    ...
                    <div><a class="remove-underline hvr-back" href="/docs/analytics/">&larr; Previous</a></div>
            ...
            <div>
                    ...
                    <div class="uk-text-right"><a class="remove-underline hvr-forward" href="/docs/boxes/">Next &rarr;</a></div>
