...
<p>Changelog enties are added in <code class="highlighter-rouge">_data/changelog.yml</code>:</p>
...
<p>Tags can be modified in <code class="highlighter-rouge">_data/tags.yml</code>:</p>
