...
<title>Google Analytics | Docs</title>
<meta property="og:title" content="Google Analytics" />
<meta name="author" content="evan" />
<meta property="og:locale" content="en" />
<meta name="description" content="To enable Google Anaytics, add the following lines to your Jekyll site:" />
<meta property="og:description" content="To enable Google Anaytics, add the following lines to your Jekyll site:" />
<link rel="canonical" href="/docs/analytics/" />
<meta property="og:url" content="/docs/analytics/" />
<meta property="og:site_name" content="Docs" />
<meta property="og:type" content="article" />
<meta property="article:published_time" content="2020-04-01T05:11:38-05:00" />
<script type="application/ld+json">
{"description":"To enable Google Anaytics, add the following lines to your Jekyll site:","image":null,"@type":"BlogPosting","url":"/docs/analytics/","name":null,"publisher":null,"headline":"Google Analytics","dateModified":"2020-04-01T05:11:38-05:00","datePublished":"2020-04-01T05:11:38-05:00","sameAs":null,"author":{"@type":"Person","name":"evan"},"mainEntityOfPage":{"@type":"WebPage","@id":"/docs/analytics/"},"@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
        ...
        <div class="uk-grid-large" data-uk-grid>
            ...
            <div class="sidebar-fixed-width uk-visible@m">
                <div class="sidebar-docs uk-position-fixed uk-margin-top">
                    ...
                    <ul class="uk-nav uk-nav-default doc-nav">
                      ...
                      <li class="uk-active"><a href="/docs/analytics/">Google Analytics</a></li>
            ...
            <div class="uk-width-1-1 uk-width-expand@m">
                ...
                <article class="uk-article">
                    ...
                    <h1 class="uk-article-title">Google Analytics</h1>
  ...
  <time datetime="2020-04-01T05:11:38-05:00" itemprop="datePublished">
    ...
    Apr 1, 2020
                    ...
                    <div class="article-content link-primary">
                        <p>To enable Google Anaytics, add the following lines to your Jekyll site:</p>

<div class="language-yaml highlighter-rouge"><pre class="highlight"><code>  <span class="s">google_analytics</span><span class="pi">:</span> <span class="s">UA-NNNNNNNN-N</span>
</code></pre>
</div>

<p>Google Analytics will only appear in production, i.e., <code class="highlighter-rouge">JEKYLL_ENV=production</code></p>

                        
                            <div class="share uk-text-center uk-margin-medium-top">
    
        <a class="uk-link-muted" href="https://twitter.com/intent/tweet?text=Google Analytics&url=/docs/analytics/&via=&related=" rel="nofollow" target="_blank" title="Share on Twitter" onclick="window.open(this.href, 'twitter', 'width=550,height=235');return false;"><span data-uk-icon="icon: twitter; ratio: 1.2"></span></a>
    
    
        <a class="uk-link-muted uk-margin-small-left" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%3A4000%2Fdocs%2Fanalytics%2F" rel="nofollow" target="_blank" title="Share on Facebook" onclick="window.open(this.href, 'facebook-share','width=580,height=296');return false;"><span data-uk-icon="icon: facebook; ratio: 1.2"></span></a>
    ...
    <div class="uk-margin-large-top paginate-post">
        <div class="uk-child-width-expand@s uk-grid-large uk-pagi" data-uk-grid>
            <div>
                    ...
                    <div><a class="remove-underline hvr-back" href="/docs/comments/">&larr; Previous</a></div>
            ...
            <div>
                    ...
                    <div class="uk-text-right"><a class="remove-underline hvr-forward" href="/docs/hero/">Next &rarr;</a></div>
